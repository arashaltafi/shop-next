    ...
    return (
        <div className='select-none mt-20 w-full flex flex-col items-center justify-center gap-12 px-16'>
            <div className='flex flex-row items-center justify-between w-full'>
                <div className='flex flex-row items-center justify-center gap-2 text-lg transition-all duration-200 cursor-pointer text-brown-200 hover:text-white hover:bg-brown-600 hover:scale-105 active:scale-95 rounded-xl px-4 py-2'>
                    <FaAngleLeft />
                    <h6>مشاهده همه</h6>
                </div>
