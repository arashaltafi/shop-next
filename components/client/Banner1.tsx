...
const Banner1 = () => {
    return (
        <div className='select-none w-full flex flex-col gap-8 items-center justify-center'>
            <div className='relative flex flex-row items-center justify-between w-[80%] px-16 py-8 bg-[#54372B] rounded-2xl border border-solid border-brown-500'>
                <Image
                ...
                <h2 dir='rtl' className='py-8 font-light text-xl leading-8 text-brown-200'>
