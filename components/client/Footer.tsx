...
const Footer = () => {
  ...
  return (
    <div className='relative select-none w-full flex flex-col items-center justify-between gap-8 px-16 pt-8 pb-4'>
      <Image
        className='absolute inset-0 w-full h-full bg-gradient-to-r from-[10%] to-[90%] from-brown-900 to-transparent border-t border-solid border-brown-400 -z-10'
        src={bgFooter}
      ...
      <li dir='rtl' className='w-full text-brown-100 text-sm font-light leading-8 list-disc text-ellipsis text-justify'>
      ...
      <div className='w-full flex flex-row gap-8 items-center justify-between bg-brown-100 px-16 py-8 rounded-xl'>
        <div className='w-full flex flex-row gap-x-8 items-center justify-between bg-yellow-600 rounded-lg px-8 py-4'>
        ...
        <div dir='rtl' className='w-full flex gap-y-2 flex-col text-brown-900'>
          <h4 className='text-xl font-bold'>اطلاع رسانی</h4>
          <h6 className='text-lg font-light'>ایمیل‌تان را وارد کنید تا از تخفیف‌ها باخبر شوید.</h6>
        </div>
      </div>

      <span className='w-screen h-0.5 bg-brown-700 rounded-full' />

      <div className='w-full flex flex-row items-center justify-center text-brown-100'>
