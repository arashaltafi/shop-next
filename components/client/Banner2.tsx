...
const Banner2 = () => {
    return (
        <div className='mt-24 select-none w-full flex flex-col gap-8 items-center justify-center'>
            <div className='overflow-hidden relative flex flex-row gap-8 items-center justify-between w-[80%] px-16 py-8 bg-[#54372B] rounded-2xl border border-solid border-brown-500'>
