...
const MainHeader = () => {
    return (
        <div className='select-none relative w-full h-[70vh] lg:h-[80vh] xl:h-[90vh] bg-gradient-to-bl from-[1%] to-[99%] from-[#7C573C] to-transparent customBorderBottom overflow-hidden'>
            <Header isFromMainHeader={true} />

            <div className='container select-none relative w-full h-full flex flex-row justify-between overflow-hidden'>
